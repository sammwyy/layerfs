...
This document is the design reference for LayerFS. It describes the target
architecture and intended semantics. Where the code has taken a different
path than a section below describes, the code is authoritative — update the
specification rather than trusting it blindly.
